...
import BrowserSessions from '@/components/settings/organisms/BrowserSessions.vue';
import type { UserSession } from '@/components/settings/organisms/BrowserSessions.vue';
...
<template>
    ...
    <div class="space-y-10">
        ...
        <div class="border-t border-slate-200/80 pt-8 dark:border-zinc-800/80">

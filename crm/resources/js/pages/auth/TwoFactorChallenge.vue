...
const authConfigContent = computed<TwoFactorConfigContent>(() => {
    if (showRecoveryInput.value) {
        return {
            ...
            description: t('auth.twoFactorDescRecovery'),
            buttonText: t('auth.loginWithAuthCode'),
        };
    }

    return {
        title: t('auth.twoFactorTitle'),
        description: t('auth.twoFactorDescCode'),
        buttonText: t('auth.loginWithRecoveryCode'),
    };
});
        ...
        <template v-else>
            ...
            >
                <Input
                    name="recovery_code"
                    type="text"
                    :placeholder="t('auth.enterRecoveryCodePlaceholder')"

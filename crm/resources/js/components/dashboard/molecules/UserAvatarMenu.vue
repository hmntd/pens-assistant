...
<template>
    <DropdownMenu>
        <DropdownMenuTrigger as-child>
            <button type="button"
                ...
                <div class="hidden flex-col items-start sm:flex text-left">
                    <span
                        class="text-xs font-bold text-slate-900 dark:text-white group-hover:text-main-dark dark:group-hover:text-main transition-colors leading-none">
        ...
        <DropdownMenuContent align="end"
            class="w-56 rounded-2xl p-1 shadow-xl bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 text-slate-900 dark:text-white">

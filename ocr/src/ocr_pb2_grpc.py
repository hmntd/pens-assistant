...
class OcrServiceStub:
    ...
    def __init__(self, channel):
        ...
        """
        self.RecognizeTaxDocument = channel.unary_unary(
                '/ocr.OcrService/RecognizeTaxDocument',
...
def add_OcrServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RecognizeTaxDocument': grpc.unary_unary_rpc_method_handler(
                    servicer.RecognizeTaxDocument,
...
class OcrService:
    ...
    @staticmethod
    def RecognizeTaxDocument(request,
            target,
            options=(),
